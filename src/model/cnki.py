...
def positioned_element():  # 定位元素
    xpaths = {
        ...
        'xx': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[1]/a''',
        'xx_sum': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[1]/a/em''',
        'xw': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[2]/a''',
        'xw_sum': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[2]/a/em''',
        'hy': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[3]/a''',
        'hy_sum': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[3]/a/em''',
        'pa': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[4]/a''',
        'pa_sum': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[4]/a/em''',
        'nj': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[5]/a''',
        'ts': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[6]/a''',
        'ts_sum': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[6]/a/em''',
        'zl': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[7]/a''',
        'bz': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[8]/a''',
        'bz_sum': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[8]/a/em''',
        'cg': '''//*[@id="ModuleSearch"]/div[2]/div/div/ul/li[9]/a''',
